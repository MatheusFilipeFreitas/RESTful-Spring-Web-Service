...
public class UserServiceImpl implements UserService{
    ...
    public UserDto createUser(UserDto user) {
        ...
        mailSender.send(userEntity.getEmail(), buildEmail(userEntity.getFirstName(),userEntity.getLastName(), link));
    ...
    private String buildEmail(String name, String lastName, String link) {
